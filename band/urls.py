...
urlpatterns = [
    ...
    path('services/<str:plan_id>/members/add/', views.service_member_add, name='service_member_add'),
    path('services/<str:plan_id>/members/<int:member_id>/remove/', views.service_member_remove, name='service_member_remove'),
